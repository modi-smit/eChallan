                ...
                <table className="w-full text-left border-collapse text-xs">
                  <thead className="bg-gray-100 border-b-2 border-black font-bold uppercase sticky top-0 z-10 shadow-sm">
                    <tr>
                      ...
                      <th className="p-3 text-center border-r border-gray-300 whitespace-nowrap">QTY</th>
                            ...
                            <div className="flex flex-col gap-2 min-w-[140px] max-w-[200px]">
                              {openNoteId === group.keyValue ? (
                                <div className="flex flex-col gap-1 w-full mt-1">
                                  <textarea
                                    className="w-full border-2 border-black p-1.5 text-xs font-bold focus:outline-none focus:bg-yellow-50 resize-none whitespace-pre-wrap break-words"
                                    rows="3"
                                    value={tempNoteText}
                                ...
                                <div className="flex flex-col items-start gap-1">
                                  <button 
                                    ...
                                    className="text-[10px] px-2 py-1 border border-gray-400 rounded shadow-sm font-bold uppercase bg-white hover:bg-gray-100"
                                  >
                                    {group.admin_note ? 'EDIT NOTE' : '+ ADD NOTE'}
                                  </button>
                                  {group.admin_note && (
                                    <div className="text-xs font-bold text-gray-800 whitespace-pre-wrap break-words leading-tight mt-1">
                                      {group.admin_note}
                                    </div>
                                  )}
                                </div>
                        ...
                        <td className="p-3 text-center vertical-middle">
                          {group.challan_no && isWithin30Days(group.timestamp) ? (
                            <button onClick={() => {
                              ...
                              className="text-[10px] font-bold bg-white border border-gray-400 text-gray-800 hover:bg-gray-100 px-2.5 py-1 rounded shadow-[1px_1px_0px_0px_rgba(0,0,0,1)] active:translate-y-px active:shadow-none"
                            >
                              PDF
                            </button>
                          ) : group.challan_no ? (
